            ...
            <div class="content-sticky-footer">
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a href="/magazzino/trasporto/<?php echo $cd_do ?>/<?php echo $cd_cf ?>/<?php echo $do->Id_DoTes ?>" class="media">
                    ...
                    <?php }  if(sizeof($documenti)>=10) {?>
                        <button type="button" class="btn btn-danger btn-sm" onclick="gotobolla()" >Mostra i primi 10 Documenti</button>
                        <?php } ?>
...
<script type="text/javascript">
    ...
    function gotobolla(){
        ...
        top.location.href = '<?php echo URL::asset('/magazzino/trasporto_documento/'.$cd_do.'/'.$cd_cf) ?>'
    }
