    ...
    <div class="page">
        ...
        <header class="row m-0 fixed-header">
            ...
            <div class="col center">
                <a href="#" class="logo"><figure><img src="/img/logo_arca.png" alt=""></figure>Scarico Magazzino</a>
            </div>
            <div class="right">
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a <?php switch($d->Cd_Do){
                            case "O02":
                                echo 'href="/magazzino/scarico03/212/'.$d->Cd_Do;echo '"';
                                break;
                            case "O03":
                                echo 'href="/magazzino/scarico03/213/'.$d->Cd_Do;echo '"';
                                break;
                            case "O04":
                                echo 'href="/magazzino/scarico03/214/'.$d->Cd_Do;echo '"';
                                break;
                            case "O05":
                                echo 'href="/magazzino/scarico03/2479/'.$d->Cd_Do;echo '"';
                                break;
                            case "O06":
                                echo 'href="/magazzino/scarico03/215/'.$d->Cd_Do;echo '"';
                                break;
                            case "O07":
                                echo 'href="/magazzino/scarico03/216/'.$d->Cd_Do;echo '"';
                                break;
                            case "O11":
                                echo 'href="/magazzino/scarico03/340/'.$d->Cd_Do;echo '"';
                                break;
                            case "PRV":
                                echo 'href="/magazzino/carico02/'.$d->Cd_Do;echo '"';
                                break;
                            case "FA ":
                                echo 'href="/magazzino/carico02/'.$d->Cd_Do;echo '"';
                                break;
