                ...
                <ul class="list-group" id="ajax" >
                    ...
                    <?php  foreach($documenti as $do){ ?>
                        ...
                        <li class="list-group-item">
                            <a href="/magazzino/scarico04/<?php echo $cliente->Id_CF ?>/<?php echo $do->Id_DoTes ?>" class="media">
        ...
        <form method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Cliente : <small><?php echo $cliente->Descrizione ?></small></h4>
...
<div class="modal" id="modal_evasione" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Scegli Documento (OAF)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <h3>Cliente : <?php echo $cliente->Cd_CF ?></h3>
                    ...
                    <label>Data Documento</label>
                    <input class="form-control" type="text" placeholder="Data Del Documento" id="DataDoc" value="<?php echo $d->DataDoc ?>" readonly>
...
<script type="text/javascript">
    ...
    function gotobolla(){
        top.location.href = "/magazzino/scarico03_tot/<?php echo $cliente->Id_CF?>/<?php echo $cd_do?>";
    }
    ...
    function crea_documento(){
        ...
        if(numero != '' && data != ''){
            ...
            $.ajax({
                url: "<?php echo URL::asset('ajax/crea_documento') ?>/<?php echo $cliente->Cd_CF ?>/<?php echo $cd_do ?>/"+numero+"/"+data+"/"+0
            }).done(function(result) {
                $('#modal_alertDocumento').modal('show');
                top.location.href = "/magazzino/scarico04/<?php echo $cliente->Id_CF ?>/"+result;
            });
    ...
    function redirect(dotes){
        ...
        if(dotes != '') {
            ...
            top.location.href = "/magazzino/scarico4/<?php echo $id_cliente ?>/"+dotes;
        }
    }
</script>
