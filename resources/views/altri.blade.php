    ...
    <div class="page">
        ...
        <header class="row m-0 fixed-header">
            ...
            <div class="col center">
                <a href="#" class="logo"><figure><img src="/img/logo_arca.png" alt=""></figure>Altri Documenti</a>
            </div>
            <div class="right">
            ...
            <div class="content-sticky-footer">
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a <?php if($d->Cd_Do=='CPI'){echo 'href="/magazzino/produzione2/'.$d->Cd_Do;echo '"';}else{echo 'href="/magazzino/altri';echo '"';} ?> class="media">
