            ...
            <div class="content-sticky-footer">
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a href="/magazzino/produzione3/<?php echo $do->Id_DoTes ?>/<?php echo $cd_cf?>" class="media">
                    ...
                    <?php } ?>
                        <button type="button" class="btn btn-danger btn-sm" onclick="gotobolla()" >Mostra meno Documenti</button>
        ...
        <form method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control" type="text" placeholder="Data Del Documento" id="DataDoc" value="<?php echo date('Y-m-d') ?>" >
                    <label>Listino</label>
                    <select class="form-control" type="text" id="Listino">
                        <option>UACQ</option>
                        <option>LPROD</option>
                    </select>
                </div>
...
<script type="text/javascript">
    ...
    function crea_documento(){
        ...
        if(numero != '' && data != '' ){
            ...
            $.ajax({
                url: "<?php echo URL::asset('ajax/crea_documento') ?>/<?php echo $cd_cf.'/'.$cd_do ?>/"+numero+"/"+data+"/"+listino
            }).done(function(result) {
                location.href='/magazzino/produzione3/'+result+'/F000123';
            });
    ...
    function gotobolla(){
        ...
        top.location.href = '<?php echo URL::asset('/magazzino/produzione2/'.$cd_do) ?>'
    }
