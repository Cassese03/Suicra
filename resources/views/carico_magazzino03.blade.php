...
<div class="modal" id="modal_evasione" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <?php if($doc_evadi != null){?>
                            <h5 class="modal-title" id="exampleModalLabel">Scegli Documento</h5>
                        <?php }else{?>
                            <h5 class="modal-title" id="exampleModalLabel">Nessun Documento Trovato</h5>
                        <?php }?>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
...
<script type="text/javascript">
    ...
    function gotobolla(){
        top.location.href = "/magazzino/carico03_tot/<?php echo $fornitore->Id_CF?>/<?php echo $cd_do?>";
    }
