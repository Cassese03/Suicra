    ...
    <div class="page">
        <form class="searchcontrol">
            <div class="input-group">
                ...
                <input type="text" id="cerca" class="form-control border-0" placeholder="Cerca Cliente..." aria-label="Username" autocomplete="off" autofocus>
                <input type="hidden" id="dest" value="<?php echo $documenti;?>">
            </div>
        </form>
        <header class="row m-0 fixed-header">
            <div class="left">
                <a style="padding-left:20px;" href="/magazzino/<?php if($documenti == 'PRV' || $documenti == 'OC'||$documenti == 'FA'||$documenti == 'B2') echo 'attivo';else echo 'passivi'?>" ><i class="material-icons">arrow_back_ios</i></a>
            </div>
            ...
            <div class="content-sticky-footer">
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a href="/magazzino/<?php if(str_replace(' ','',$documenti)=='OC') echo 'scarico03'; else echo 'carico03' ?>/<?php echo $f->Id_CF ?>/<?php echo $documenti ?>" class="media">
