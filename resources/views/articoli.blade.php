...
<div class="wrapper">
    ...
    <div class="page">
        ...
        <header class="row m-0 fixed-header">
            ...
            <div class="col center">
                <a href="#" class="logo"><figure><img src="img/logo_arca.png" alt=""></figure> Articoli</a>
            </div>
            <div class="right">
        ...
        <div class="page-content">
            <div class="content-sticky-footer">
                ...
                <div class="w-100">
                    <h1 class="text-center text-white title-background">Gestione Articoli</h1>
                </div>

              <div class="row mx-0" style="margin-bottom:10px;">
                    <div class="col-12">
                        <!--
                        <a href="<?php /* echo URL::asset('nuovo_articolo')*/ ?>" class="btn btn-success btn-sm" style="width:100%">+ Crea Nuovo Articolo</a>
                        -->
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#cerca').on('keydown', function(e) {
        if (e.which == 13) {
            cerca_articolo($('#cerca').val());
            e.preventDefault();
        }
    });

    function cerca_articolo(testo){

        $.ajax({
            url: "<?php echo URL::asset('ajax/cerca_articolo') ?>/"+encodeURIComponent(testo),
